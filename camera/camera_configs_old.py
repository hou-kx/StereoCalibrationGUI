# @
# -*- encoding:utf-8 -*-
# filename: camera_configs_old.py
# 我想走的路不怎么顺畅
#
...
left_distortion = np.array([[-0.4481, 0.3621, -2.4279e-04, -0.0041, 0]])
...
right_distortion = np.array([[-0.4456, 0.3723, -0.0013, -0.0029, 0]])
...
# 平移关系向量
T = np.array([-60.0418, -0.4772, 3.2847])
